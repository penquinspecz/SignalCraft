...
Evidence: `src/ji_engine/dashboard/app.py`, `tests/test_dashboard_app.py`, `scripts/dashboard_offline_sanity.py`, `Makefile` target `dashboard-sanity`, `docs/DASHBOARD_API.md`, `docs/OPERATIONS.md`, `scripts/dev/curl_dashboard_proof.sh`, `docs/proof/m17-api-boring-pack-2026-02-15.md`, `docs/proof/m17-artifact-index-endpoint-2026-02-14.md`, `docs/proof/m17-api-boring-pack-smoke-negative-2026-02-15.md`, `docs/proof/p1-artifact-download-size-cap-2026-02-17.md`, `docs/proof/dashboard-offline-sanity-m14-m15-m16-2026-02-21.md`.
